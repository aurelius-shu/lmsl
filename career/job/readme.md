...
```
工作职责
负责公司级研发及运营平台的开发，致力于提升公司在具体领域内的研发及运营效率，服务于公司所有研发&运维人员，涉及的内容包括软件源、配置中心、名字服务等； 负责研发效能相关平台、基础服务的研发，致力于提升基础的研发效率，涉及的内容包括CI、发布、监控、日志数据平台等； 负责运营体系、运营平台的建设，致力于提升部门业务的运营效率、运营质量。
任职资格
熟悉Linux操作系统，精通/Java/Go/Python任一种语言； 具备3年以上开发经验，有良好的编码习惯； 具有良好的学习能力、沟通能力、服务理念和合作精神； 强烈的责任心与主动性，对所负责工作有owner意识，并能自我驱动成长； 有运维自动化、监控系统、发布系统、运营支撑系统等开发经验者优先； 有大型分布式系统设计与开发经验者优先。
```

```
腾讯音乐

负责企业发展部系统后台能力建设，包括音乐人、榜单及未来新业务系统；  负责海量日志数据的接入和清洗等相关工作；负责整个音乐人社区和榜单分发系统的开发。
岗位要求
本科以上学历，计算机相关专业；  
熟练掌握Java，3年以上系统研发和软件设计经验，具备互联网高并发大型系统设计与研发经验；  
有高并发高吞吐系统开发经验，对系统调优有一定经验，精通 MySQL 应用开发，熟悉数据库原理和常用性能优化技术，以及 NoSQL，消息队列 的原理、使用场景以及限制；  
参与过大型复杂分布式互联网系统的设计开发者优先，拥有和工作年限相称的广度和（或）深度；  
有较强的逻辑思维能力，善于分析、归纳、解决问题，有独立或带队进行项目开发能力者优先。

岗位描述
1、负责开发内容与数据中台产品，涉及“接入-存储-计算-管理-应用”全链路； 
2、参与项目的需求分析、架构设计及关键技术的研发工作； 
3、解决平台上线后生产环境的各种实际问题，保障数据产品在生产环境稳定高效地运行。
岗位要求
1、5年以上Java后台开发经验，熟悉Spring/Dubbo/Mybatis等主流开发框架； 
2、有大数据平台/数据中台研发经验优先，熟悉数据采集、数据可视化、数据开发等流程； 
3、熟悉Hadoop、HBase、Elasticsearch系统者优先；
```
